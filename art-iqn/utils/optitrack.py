...
class NatNetClient:
    ...
    def __unpackRigidBody(self, data):
        ...
        if(((self.__natNetStreamVersion[0] == 2) and (self.__natNetStreamVersion[1] >= 6)) 
    ...
    def __unpackMocapData(self, data):
        ...
        skeletonCount = 0
        if((self.__natNetStreamVersion[0] == 2 and self.__natNetStreamVersion[1] > 0) 
                                                or self.__natNetStreamVersion[0] > 2):
        ...
        if((self.__natNetStreamVersion[0] == 2 and self.__natNetStreamVersion[1] > 3) 
                                                or self.__natNetStreamVersion[0] > 2):
        ...
        if((self.__natNetStreamVersion[0] == 2 and self.__natNetStreamVersion[1] >= 9) 
                                                or self.__natNetStreamVersion[0] > 2):
        ...
        if((self.__natNetStreamVersion[0] == 2 and self.__natNetStreamVersion[1] >= 7) 
                                                or self.__natNetStreamVersion[0] > 2):
