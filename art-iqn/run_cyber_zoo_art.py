...
if __name__ == '__main__':
    ...
    with SyncCrazyflie(URI, cf=cf) as scf:
        ...
        with MotionCommander(scf) as motion_commander:
            ...
            with Multiranger(scf) as multiranger:
                ...
                while not done:
                    ...
                    logger['states'].append((state, action_id, tcv, cvar))
                    #print(tcv, cvar, action)
        ...
        pickle.dump(logger, open("experimentsCyberZoo/loggers/{}.pkl".format(args.exp_id), 'wb'))
